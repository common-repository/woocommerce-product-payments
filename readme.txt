...
Contributors: dreamfox, freemius
Tags: WooCommerce, payment gateway, product
...
You can select for each individual product the payment gateway that will be used by checkout. If no selection is made, then the default payment gateways are displayed. If you for example only select paypal then only paypal will available for that product by checking out.
...
== NOTE ==
*Uninstall free version of that plugin otherwise might get error.
...
= 3.2.9 =
* Bugfix add to cart by use of Venmo
* Corrected urls to FAQ

= 3.2.8 =
* Bugfix add to cart
* Minor updates
* Vulnerability fixed
* check with latest woocommerce and wordpress
...
= 3.1.9 =
* check with latest woocommerce and wordpress
* Updated freemius SDK to 4.4.2

= 3.1.8 =
* check with latest woocommerce and wordpress
* bugfix payment when order is paid later
...
= 3.1.4 =
* check with latest woocommerce and wordpress
* added new feature payment gateway per tag
* added new feature add paymkent gateway per category
* changed newsletter subscription to new provider
...
= 3.1.0 =
* bump freemius SDK to 2.4.1

= 3.0.9 =
* check with latest woocommerce and wordpress and fixed bug wp 5.5

= 3.0.7 =
* check with latest woocommerce and wordpress

= 1.4.7 =
* Fixed update license tocheck once a day

= 1.4.5 =
* Fixed update license issue and update code to latest standards

= 1.4.4 =
* Fixed update license issue as latest update of woocommerce
...
= 1.3.3 =
* Add Quick Edit and Bulk Edit functionality
* Fixed error in automatically disappear shipping options after quick/bulk edit

= 1.3.2 =
* fixed error on switching from Free to Full version

= 1.3.1 =
* Support multi Network

= 1.3.0 =
* Fix major bug by handle proper condition check license on activation.

= 1.2.9 =
* Fix major bug by handle proper condition.
